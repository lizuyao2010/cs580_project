...
window.onload=function()
{
    ...
    //model
    $('#uscLogo').click(function(){
        ui.setObjects(makeUSC());
        func=makeUSC();
    });
    ...
    //light
    $('#lightsList').append('<button type="button" class="btn btn-default" id = \'newLight\'><i class="fa fa-plus"></i>&nbsp;<i class="fa fa-lightbulb-o fa-2x"></i></button>');
    $('#newLight').click(function(){
        lights.push(new RealLight(light2,whiteColor));
        ui.setObjects(func);
        //ui.setObjects(makeUSC());
        showLightList();
    });
    ...
    $('#red').click(function(){
        background='else if(hit.x > 2.9999) surfaceColor = vec3(0.9, 0.0, 0.1);';
        ui.renderer.setObjects(ui.renderer.objects);
        return;
    })
    $('#green').click(function(){
        background='else if(hit.x > 2.9999) surfaceColor = vec3(0.0, 0.9, 0.1);';
        ui.renderer.setObjects(ui.renderer.objects);
        return;
    })
...
function showLightList(){
    ...
    for(var i=0;i<lights.length;i++){
        $('#lightsList').append('<button type="button" class="btn btn-default" id = \'light'+i+'\'> <i class="fa fa-lightbulb-o fa-2x"></i></button>');
    }
    setLightInfo();
}
...
function setLightInfo(){
    $("#light0").click(function(){
        var i=0;
        $('#lightInfo').html('');
        $('#lightInfo').append('R <input type="text" class="lightColor" id="R" value="'+Math.floor(lights[i].color.elements[0]*255)+'">');
        $('#lightInfo').append('G <input type="text" class="lightColor" id="G" value="'+Math.floor(lights[i].color.elements[1]*255)+'">');
        $('#lightInfo').append('B <input type="text" class="lightColor" id="B" value="'+Math.floor(lights[i].color.elements[2]*255)+'"><br/>');
        $('#lightInfo').append('X <input type="text" class="lightColor" id="X" value="'+lights[i].direction.elements[0]+'">');
        $('#lightInfo').append('Y <input type="text" class="lightColor" id="Y" value="'+lights[i].direction.elements[1]+'">');
        $('#lightInfo').append('Z <input type="text" class="lightColor" id="Z" value="'+lights[i].direction.elements[2]+'"><br/>');
        $('#lightInfo').append('<button type="button" class="btn btn-default lightBtn" id = \'ok\'> <i class="fa fa-undo fa-2x"></i></button>');
        $('#lightInfo').show();
        $('#ok').click(function(){
            ui.renderer.sampleCount=0;
            lights[0].color.elements[0]=$("#R").val()/255;
            lights[0].color.elements[1]=$("#G").val()/255;
            lights[0].color.elements[2]=$("#B").val()/255;
            lights[0].direction.elements[0]=$("#X").val()*1.0;
            lights[0].direction.elements[1]=$("#Y").val()*1.0;
            lights[0].direction.elements[2]=$("#Z").val()*1.0;
        }); 
    });
    $("#light1").click(function(){
        ...
        $('#ok').click(function(){
            ui.renderer.sampleCount=0;
            lights[1].color.elements[0]=$("#R").val()/255;
            lights[1].color.elements[1]=$("#G").val()/255;
            lights[1].color.elements[2]=$("#B").val()/255;
            lights[1].direction.elements[0]=$("#X").val()*1.0;
            lights[1].direction.elements[1]=$("#Y").val()*1.0;
            lights[1].direction.elements[2]=$("#Z").val()*1.0;
        }); 
    });
    $("#light2").click(function(){
        ...
        $('#ok').click(function(){
            ui.renderer.sampleCount=0;
            lights[2].color.elements[0]=$("#R").val()/255;
            lights[2].color.elements[1]=$("#G").val()/255;
            lights[2].color.elements[2]=$("#B").val()/255;
            lights[2].direction.elements[0]=$("#X").val()*1.0;
            lights[2].direction.elements[1]=$("#Y").val()*1.0;
            lights[2].direction.elements[2]=$("#Z").val()*1.0;
        }); 
    });
    $("#light3").click(function(){
        ...
        $('#ok').click(function(){
            ui.renderer.sampleCount=0;
            lights[3].color.elements[0]=$("#R").val()/255;
            lights[3].color.elements[1]=$("#G").val()/255;
            lights[3].color.elements[2]=$("#B").val()/255;
            lights[3].direction.elements[0]=$("#X").val()*1.0;
            lights[3].direction.elements[1]=$("#Y").val()*1.0;
            lights[3].direction.elements[2]=$("#Z").val()*1.0;
        }); 
    });
}
...
function makeUSC(){
    ...
    objects.push(new Cube( Vector.create([-0.3, 1, -0.1]), Vector.create([0.5, 1.2, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-0.5, 1, -0.1]), Vector.create([-0.3, 0.1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-0.3, -0.1, -0.1]), Vector.create([0.3, 0.1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1));
    objects.push(new Cube( Vector.create([0.5, -1, 0.1]), Vector.create([0.3, -0.1, -0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([0.3, -1, 0.1]), Vector.create([-0.5, -1.2, -0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    
    objects.push(new Cube( Vector.create([1, 1, -0.1]), Vector.create([1.8, 1.2, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([0.8, 1, -0.1]), Vector.create([1, 0.1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([0.8, -0.1, -0.1]), Vector.create([1, -1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([1.8, -1, 0.1]), Vector.create([1, -1.2, -0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    
    objects.push(new Cube( Vector.create([-1.8, 1.2, -0.1]), Vector.create([-1.6, 0.1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-1.0, 1.2, -0.1]), Vector.create([-0.8, 0.1, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-1.8, -0.1, -0.1]), Vector.create([-1.6, -1.0, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-1.0, -0.1, -0.1]), Vector.create([-0.8, -1.0, 0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    objects.push(new Cube( Vector.create([-1, -1, 0.1]), Vector.create([-1.6, -1.2, -0.1]) , nextObjectId++,Vector.create([0.75, 0 , 0]),1)); 
    return objects;
}
...
function makeSpheres(){
    ...
    objects.push(new Sphere(Vector.create([0, 0, -1]), 0.60, nextObjectId++,Vector.create([0.75, 0.75, 0.75]),3));
    objects.push(new Sphere(Vector.create([0, 0, 1]), 0.6, nextObjectId++,Vector.create([0.75,0.75, 0.75]),2));
    objects.push(new Sphere(Vector.create([0, 1, 0]), 0.6, nextObjectId++,Vector.create([0.75,0.75, 0.75]),1));
    objects.push(new Sphere(Vector.create([0, -1, 0]), 0.6, nextObjectId++,Vector.create([0.75,0.75, 0.75]),0));
    return objects;
}
//by Abdullah
